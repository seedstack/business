...
class SpecificationBuilderImpl implements SpecificationBuilder {
    public <A extends AggregateRoot<?>> SpecificationPropertyPicker<A> of(Class<A> aggregateClass) {
        return new SpecificationPropertyPickerImpl<>(new SpecificationBuilderContext<>(aggregateClass));
    }
}
