...
/**
 * An element of the {@link Paginator} DSL allowing to choose the pagination type. Three pagination types are supported:
 * <ul>
 * <li>Offset-based which allows to skip a specified amount of objects,</li>
 * <li>Page-based which is similar to offset-based but allows to specify the amount of skipped objects as a number of pages,</li>
 * <li>Key-based which allows to select objects that come after a specific value of a specific attribute.</li>
 * </ul>
 *
...
public interface PaginationTypePicker<A extends AggregateRoot<ID>, ID> {
    ...
    /**
     * Choose an offset-based pagination type. Objects that come before the specified index will be skipped.
     *
     * @param startingOffset the index of first object that will be returned.
     * @return the next operation of the paginator DSL, allowing to specify a limit to the number of objects returned.
     */
     ...
     * @return the next operation of the paginator DSL, allowing to specify the value used as boundary.
     */
