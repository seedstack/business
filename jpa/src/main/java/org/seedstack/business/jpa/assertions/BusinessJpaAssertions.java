...
import org.seedstack.business.jpa.assertions.asserts.BusinessJpaClassAssert;
...
/**
 * This class provide business assertion on JPA.
 * 
...
public final class BusinessJpaAssertions  {
	...
	public static BusinessJpaClassAssert assertThat(Class<?> actual) {
	   ...
	   */
	  public static <T> CoreObjectAssert<T> assertThat(T actual) {
		  return new CoreObjectAssert<T>(actual);
	  }
