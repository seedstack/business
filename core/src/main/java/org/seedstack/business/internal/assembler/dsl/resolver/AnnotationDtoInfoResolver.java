...
/**
 * Implementation of the {@link DtoInfoResolver}
...
public class AnnotationDtoInfoResolver extends BaseDtoInfoResolver {
    ...
    public <D, ID> ID resolveId(D dto, Class<ID> aggregateIdClass, int position) {
        ...
        if (position == -1) {
            ...
            return createIdentifier(aggregateIdClass, parameterHolder.uniqueElementForAggregate(dto, position), parameterHolder.parametersOfAggregateRoot(dto, position));
        }
    }
