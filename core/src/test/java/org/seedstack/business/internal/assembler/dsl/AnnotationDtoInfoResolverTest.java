...
import org.seedstack.business.fixtures.assembler.annotated.Case4Dto;
...
public class AnnotationDtoInfoResolverTest {
    ...
    public void testValueObjectIdForTuples() {
        ...
        assertThat(underTest.resolveId(case4Dto, Case4DtoVO.class, 0)).isEqualTo(new Case4DtoVO(firstName, lastName));
        assertThat(underTest.resolveId(case4Dto, Case4DtoVO.class, 1)).isEqualTo(
                new Case4DtoVO("oderItem", "description"));
    }
