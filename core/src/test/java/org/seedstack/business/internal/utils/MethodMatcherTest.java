...
public class MethodMatcherTest {
    ...
    public void test_method_matcher() {
        Method testMethod = MethodMatcher.findMatchingMethod(TestedClass.class, Integer.class, "aa",
                ProjectStatus.FIRST);
        Assertions.assertThat(testMethod)
                .isNotNull();
        Assertions.assertThat(testMethod.getName())
                .isEqualTo("test");

        Method testMethod2 = MethodMatcher.findMatchingMethod(TestedClass.class, Integer.class, "aa",
                ProjectStatus.FIRST, null);
        Assertions.assertThat(testMethod2)
                .isNotNull();
        Assertions.assertThat(testMethod2.getName())
                .isEqualTo("test2");

        Method testMethod3 = MethodMatcher.findMatchingMethod(TestedClass.class, null, "aa", 1);
        Assertions.assertThat(testMethod3)
                .isNotNull();
        Assertions.assertThat(testMethod3.getName())
                .isEqualTo("test3");
    }
