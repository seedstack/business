...
/**
 * An element of the {@link SpecificationBuilder} DSL to select all or a part of the object a clause will apply to.
 *
...
public interface BaseSelector<T, SELECTOR extends BaseSelector<T, SELECTOR>> {
    ...
    /**
     * Selects the whole object to be the subject of a specification. For instance, if an equality specification is chosen
     * later in the DSL, the equality check will apply at the global object level.
     *
     * @return the next operation of the builder DSL, allowing to choose the specification that will apply on the whole
     * object.
     */
    SpecificationPicker<T, SELECTOR> whole();
}
