...
public class MergeMultipleTuplesFromRepositoryImpl<T extends Tuple> extends AbstractMergeWithRepository implements MergeMultipleTuplesWithRepository<T>, MergeMultiplesTuplesWithRepositoryThenFactory<T> {

    private final List<Class<? extends AggregateRoot<?>>> aggregateClasses;
    private final List<?> dtos;

    public MergeMultipleTuplesFromRepositoryImpl(AssemblerDslContext context, List<Class<? extends AggregateRoot<?>>> aggregateClasses, List<?> dtos) {
        super(context);
