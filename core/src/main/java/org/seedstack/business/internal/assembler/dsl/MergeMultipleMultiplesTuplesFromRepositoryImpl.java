...
import org.seedstack.business.assembler.dsl.MergeMultiplesTuplesWithRepositoryThenFactory;
...
public class MergeMultipleMultiplesTuplesFromRepositoryImpl<T extends Tuple> extends AbstractMergeWithRepository implements MergeMultipleTuplesWithRepository<T>, MergeMultiplesTuplesWithRepositoryThenFactory<T> {

    private final List<Class<? extends AggregateRoot<?>>> aggregateClasses;
    private final List<?> dtos;

    public MergeMultipleMultiplesTuplesFromRepositoryImpl(AssemblerDslContext context, List<Class<? extends AggregateRoot<?>>> aggregateClasses, List<?> dtos) {
        super(context);
    ...
    @Override
    public MergeMultiplesTuplesWithRepositoryThenFactory<T> fromRepository() {
    ...
    public List<T> orFail() throws AggregateNotFoundException {
        ...
        for (Object dto : dtos) {
            ...
            List<Triplet<Optional<AggregateRoot<?>>, Class<?>, Object>> aggregateRootsMetadata = loadFromRepository(dto);
    ...
    @SuppressWarnings("unchecked")
    private List<Triplet<Optional<AggregateRoot<?>>, Class<?>, Object>> loadFromRepository(Object dto) {
