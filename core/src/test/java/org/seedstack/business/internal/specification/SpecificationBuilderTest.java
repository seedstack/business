...
public class SpecificationBuilderTest {
  ...
  public void setUp() throws Exception {
    ...
    greenTeam = new TeamWithLeader("GREEN", "Sammy", 36,
      new Address(11, "Tulip street", "Metropolis"));
  }
  ...
  public void testBetween() throws Exception {
    Specification<Team> spec = specificationBuilder.of(Team.class)
      ...
      .build();
    assertThat(Stream.of(redTeam, blueTeam, greenTeam).filter(spec.asPredicate()).collect(toList()))
      .containsExactly(redTeam, greenTeam);
  }
  ...
  public void testStringOptions() throws Exception {
    ...
    assertThat(
      Stream.of(redTeam, blueTeam, greenTeam).filter(specEqual.asPredicate()).collect(toList()))
      .containsExactly(redTeam);
    assertThat(
      Stream.of(redTeam, blueTeam, greenTeam).filter(specMatching.asPredicate()).collect(toList()))
      .containsExactly(redTeam);
  }
  ...
  public void testToString() throws Exception {
    ...
    assertThat(spec.toString()).isEqualTo(
      "Team[¬(leader.name = Alice) ∨ ¬(leader.name = Roger) ∨ ((leader.age < 15) ∧ ¬(leader"
        + ".address.number = 5) ∧ (leader.address.city = SomeCity))]");
  }
  ...
  public void testIdentity() throws Exception {
    Specification<Team> spec = specificationBuilder.ofAggregate(Team.class)
      ...
      .build();
    assertThat(Stream.of(redTeam, blueTeam, greenTeam).filter(spec.asPredicate()).collect(toList()))
      .containsExactly(blueTeam, greenTeam);
  }
  ...
  public void buildTrueSpecification() throws Exception {
    ...
    assertThat(((SubstitutableSpecification<Team>) spec).getSubstitute())
      .isInstanceOf(TrueSpecification.class);
  }
  ...
  public void buildFalseSpecification() throws Exception {
    ...
    assertThat(spec).isInstanceOf(SubstitutableSpecification.class);
    assertThat(((SubstitutableSpecification<Team>) spec).getSubstitute())
      .isInstanceOf(FalseSpecification.class);
  }
  ...
  public void buildUnitarySpecification() throws Exception {
    ...
    assertThat(spec).isInstanceOf(SubstitutableSpecification.class);
    assertThat(((SubstitutableSpecification<Team>) spec).getSubstitute())
      .isInstanceOf(AttributeSpecification.class);
  }
  ...
  public void buildBinaryOrSpecification() throws Exception {
    ...
    assertThat(((OrSpecification<Team>) ((SubstitutableSpecification<Team>) spec).getSubstitute())
      .getSpecifications()[0]).isInstanceOf(AttributeSpecification.class);
  }
  ...
  public void testWhole() throws Exception {
    ...
    assertThat(spec).isInstanceOf(SubstitutableSpecification.class);
    assertThat(((SubstitutableSpecification<Team>) spec).getSubstitute())
      .isInstanceOf(EqualSpecification.class);
    assertThat(Stream.of(redTeam, blueTeam, greenTeam).filter(spec.asPredicate()).collect(toList()))
