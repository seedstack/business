...
public enum BusinessErrorCode implements ErrorCode {
    ...
    SPECIFICATION_CONVERTER_WITHOUT_QUALIFIER, SPECIFICATION_TRANSLATOR_WITHOUT_QUALIFIER, SPECIFICATION_CONVERTER_WITH_INVALID_QUALIFIER, UNABLE_TO_INVOKE_FACTORY_METHOD
}
