...
class AssemblerModule extends AbstractModule {
    ...
    AssemblerModule(Map<Key<Assembler>, Class<? extends Assembler>> bindings, List<Class<? extends DtoInfoResolver>> dtoInfoResolverClasses, Collection<BindingStrategy> bindingStrategies) {
