...
/**
 * An element of the {@link FluentAssembler} DSL allowing to assemble to a {@link Page} of multiple DTO. This is only available in
 * the DSL if a page of aggregates has been specified as input.
 */
