...
public class AutomaticTupleAssemblerTest {
    ...
    private AutomaticTupleAssembler<Pair<Order, Customer>, OrderDTO> automaticAssembler;
//    private DefaultAssembler<Order, OrderDTO> defaultAssembler;

    static class AutoAssembler extends AutomaticTupleAssembler<Pair<Order, Customer>, OrderDTO> {
        @Override
