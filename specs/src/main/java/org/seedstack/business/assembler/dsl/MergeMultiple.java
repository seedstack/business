...
public interface MergeMultiple {
  ...
  <AggregateRootT extends AggregateRoot<IdT>, IdT> MergeFromRepository<MergeAs<AggregateRootT>> into(
    Class<AggregateRootT> aggregateRootClass);

  <A0 extends AggregateRoot<?>,
    A1 extends AggregateRoot<?>> MergeFromRepository<MergeAs<Pair<A0, A1>>> into(Class<A0> first, Class<A1> second);
