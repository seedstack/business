...
/**
 * A {@link Specification} is a pattern that is able to tell if a candidate object matches some criteria. The specification
 * has a method {@link #isSatisfiedBy(Object)} that returns true if all criteria are met by the candidate.
 *
...
public interface Specification<T> {
     ...
     * @return an {@link AndSpecification} composing this specification with the specification passed as argument.
     */
     ...
     *
     * @param other the other specification.
     * @return an {@link OrSpecification} composing this specification with the specification passed as argument.
     */
