...
public class AssemblerIT extends AbstractSeedIT {
    @Inject
    ...
    @Test
    public void fluentAssemblerIsInjected() throws Exception {
        assertThat(fluentAssembler).isInstanceOf(FluentAssemblerAdapter.class);
    }

    @Test
    public void fluentAssemblerIsWorking() throws Exception {
    ...
    @Test
    public void assemblersAreInjected() throws Exception {
    ...
    @Test
    public void tupleAssemblersAreInjected() throws Exception {
    ...
    @Test
    public void assemblersAreWorking() throws Exception {
    ...
    @Test
    public void tupleAssemblersAreWorking() throws Exception {
    ...
    public void fluentAssemblerCanUseAssemblerTypes() throws Exception {
