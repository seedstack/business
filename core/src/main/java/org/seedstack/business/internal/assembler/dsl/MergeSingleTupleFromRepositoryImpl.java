...
public class MergeSingleTupleFromRepositoryImpl<T extends Tuple> extends AbstractMergeWithRepository implements MergeSingleTupleWithRepository<T>, MergeSingleTupleFromRepositoryOrFactory<T> {

    private final List<Class<? extends AggregateRoot<?>>> aggregateClasses;
    private final Object dto;

    public MergeSingleTupleFromRepositoryImpl(AssemblerDslContext context, List<Class<? extends AggregateRoot<?>>> aggregateClasses, Object dto) {
        super(context);
