...
public class AssemblerInternalRegistryIT {
    ...
    public void testAssemblerOfTuple() {
        List<?> aggregateRootTuple = Lists.newArrayList(org.seedstack.business.fixtures.assembler.customer.Order.class, Customer.class);
